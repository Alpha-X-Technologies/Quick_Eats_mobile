...
import 'package:quick_eats/src/data/user_repository.dart';
...
class _AccountPageState extends State<AccountPage> {
  List<AccountListItem> accountItemList;

  @override
  void initState() {
    accountItemList = new List();
    createListItem();
    super.initState();
  }
 ...
 _showDialog(BuildContext context){
    ...
    builder: (BuildContext context){
      return AlertDialog(title: Text("Log Out Confirmation"),
      ...
      return InkWell(
        ...
        child: Container(
          ...
          child: Row(
            children: <Widget>[
              Image(
                image: AssetImage("assets/${accountItemList.icon}"),
                width: 20,
                height: 20,
