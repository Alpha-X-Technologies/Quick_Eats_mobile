...
import 'package:quick_eats/src/views/orders/ratings/rate_order.dart';
        ...
        providers: [
          ...
          MaterialApp(
            ...
            routes: {
              ...
              QuickEatsRoutes.rateOrder: (context) => RateOrderPage(),
              //QuickEatsRoutes.orderDetails: (context) => OrderDetailsPage()
            },
          ),
        )));
  }
