...
class _$MenuItemSerializer implements StructuredSerializer<MenuItem> {
  ...
  Iterable<Object> serialize(Serializers serializers, MenuItem object,
    ...
    if (object.is_favourite != null) {
      result
        ..add('is_favourite')
        ..add(serializers.serialize(object.is_favourite,
    ...
    while (iterator.moveNext()) {
      ...
      switch (key) {
        ...
        case 'item_price':
          ...
          break;
        case 'is_favourite':
          result.is_favourite = serializers.deserialize(value,
...
class _$MenuItem extends MenuItem {
  ...
  bool operator ==(Object other) {
    ...
    return other is MenuItem &&
        ...
        is_favourite == other.is_favourite;
  }
...
class MenuItemBuilder implements Builder<MenuItem, MenuItemBuilder> {
  ...
  double _item_price;
  double get item_price => _$this._item_price;
  set item_price(double item_price) => _$this._item_price = item_price;

  bool _is_favourite;
  bool get is_favourite => _$this._is_favourite;
  set is_favourite(bool is_favourite) => _$this._is_favourite = is_favourite;
  ...
  MenuItemBuilder get _$this {
    if (_$v != null) {
      ...
      _is_favourite = _$v.is_favourite;
      _$v = null;
    }
    return this;
  }
